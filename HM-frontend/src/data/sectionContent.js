export const sectionContent = {
  ladies: {
    hero: {
      eyebrow: "NEW SEASON",
      title: "Elevated layers for every day",
      subtitle:
        "Soft tailoring, textured knits and statement outerwear inspired by the AW/24 show.",
      ctaLabel: "Shop ladieswear",
      ctaLink: "#",
      image:
        "https://i.pinimg.com/736x/1d/06/1f/1d061f8d449b0739d36c781d88cdda05.jpg",
      align: "left",
    },
    promos: [
      {
        title: "Premium Cashmere",
        subtitle: "Feel-good staples from ₹3,999",
        ctaLabel: "Discover premium",
        image:
          "https://www.warasibe.com/cdn/shop/files/1c1c62a9d98b5fc0be58aa6110d27325.jpg?v=1749990311",
      },
      {
        title: "Party Edit",
        subtitle: "Sequins, satin and spotlight-ready looks",
        ctaLabel: "Shop the edit",
        image:
          "https://i.pinimg.com/736x/b9/96/ba/b996bacca649dbb04d14c50088d61ab9.jpg",
      },
    ],
    categorySection: {
      eyebrow: "SHOP BY CATEGORY",
      title: "Everything for right now",
      description: "Wardrobe foundations, bold statements and effortless basics.",
      categories: [
        {
          label: "New arrivals",
          image:
            "https://i.pinimg.com/736x/82/1a/85/821a857ac12f2e1f51790a0662bdb4d8.jpg",
        },
        {
          label: "Dresses",
          image:
            "https://i.pinimg.com/736x/38/a6/23/38a6237dbb89f970828a6c71e1cc9c23.jpg",
        },
        {
          label: "Outerwear",
          image:
            "https://i.pinimg.com/1200x/86/b2/74/86b27408f60f3709dcfb1ee1604d8bb1.jpg",
        },
        {
          label: "Shoes & accessories",
          image:
            "https://i.pinimg.com/736x/0d/35/2d/0d352ddea6ca6f7297a0f2e01655ea02.jpg",
        },
      ],
    },
    editorial: {
  ...
  men: {
    hero: {
      eyebrow: "NEW TAILORING",
      title: "Modern classics in focus",
      subtitle:
        "Precise proportions, relaxed knits and structured outerwear in elevated neutrals.",
      ctaLabel: "Shop menswear",
      image:
        "https://i.pinimg.com/1200x/47/8b/bc/478bbc7d5254df967e18eca172c51371.jpg",
      align: "right",
    },
    promos: [
      {
    ...
    categorySection: {
      eyebrow: "SHOP BY CATEGORY",
      title: "Built for every plan",
      description: "Sharp tailoring, off-duty heroes and performance-ready essentials.",
      categories: [
        {
          label: "New in",
          image:
  ...
  kids: {
    hero: {
      eyebrow: "PLAY COLLECTIVE",
      title: "Colour-forward essentials",
      subtitle:
        "Durable sets, soft denim and joyful prints sized for babies to teens.",
      ctaLabel: "Shop kidswear",
      image:
        "https://plus.unsplash.com/premium_photo-1661430931607-70b2e194f741?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8Y3V0ZSUyMGJhYmllcyUyMGNsb3RoZXMlMjBsYW5kc2NhcGUlMjBpbWd8ZW58MHwwfDB8fHww",
      align: "center",
    },
    promos: [
      {
        title: "Mini outerwear",
    ...
    categorySection: {
      ...
      description: "From newborn bundles to teen-approved fits.",
      categories: [
        {
          label: "Baby (0-2Y)",
          image:
    ...
    editorial: {
      eyebrow: "H&M KIDS LAB",
      badge: "Co-created",
      title: "Play-proof fabrics",
      description:
  ...
  home: {
    hero: {
      ...
      subtitle:
        "Layered textures, sculptural lighting and artisanal ceramics in a neutral palette.",
      ctaLabel: "Shop interior edit",
      image:
        "https://images.unsplash.com/photo-1639664701039-f747268e2243?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      align: "left",
    },
    promos: [
      {
    ...
    categorySection: {
      ...
      title: "Design, edit, repeat",
      description: "Pieces that layer seamlessly across every space.",
      categories: [
        {
          label: "Living room",
          image:
    ...
    editorial: {
      eyebrow: "DESIGN STORIES",
      badge: "Editorial",
      title: "Artisanal minimalism",
      description:
  ...
  beauty: {
    hero: {
      eyebrow: "H&M BEAUTY",
      title: "Glow-forward essentials",
      subtitle:
        "Vegan-friendly formulas, skincare hybrids and pocket-sized palettes.",
      ctaLabel: "Shop beauty",
      image:
        "https://i.pinimg.com/1200x/ae/b7/b7/aeb7b7243f34a65d4fdd06befddf08ab.jpg",
      align: "right",
    },
    promos: [
      {
        title: "Complexion lab",
    ...
    categorySection: {
      ...
      title: "Edit your ritual",
      description: "Curated capsules for skincare, makeup and body.",
      categories: [
        {
          label: "Skincare",
          image:
